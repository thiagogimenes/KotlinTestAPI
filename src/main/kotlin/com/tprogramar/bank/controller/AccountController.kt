package com.tprogramar.bank.controller

import com.tprogramar.bank.model.Account
import com.tprogramar.bank.service.AccountService
...
class AccountController (private val service: AccountService) {
    ...
    @PostMapping
    @ResponseStatus(HttpStatus.CREATED) //notação para forçar o retorno de status 201 - created
